...
### version-checker specific gems ###
# pundit, right management. Read more: https://github.com/elabs/pundit
gem 'pundit'

# CarrierWave, file storage manager. Read more: https://github.com/carrierwaveuploader/carrierwave
gem 'carrierwave', '~> 1.0'
